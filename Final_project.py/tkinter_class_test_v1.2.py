...
class Good_GUI():
    def __init__(self):
        ...
        self.INTERVALS = 0
        self.K_p_enc = random.randint(0,20)
        ...
        self.plot3.set_xlim(self.x_range)
        self.plot3.set_title('K_i', rotation='vertical',x=1.1,y=0.3)
        self.line3, = self.plot3.plot(self.xs,self.ys, color= 'blue')
        ...
        self.xs = list(range(0,self.x_len))
        self.ys = [0]* self.x_len
        self.plot4.set_xlim(self.x_range)
