...
class Navigate:
    def __init__(self) -> None:
        ...
        self.position = 2
        self.positions = ["white","red","green","blue","white"]
    ...
    def is_moving_to(self):
        #print("is moving to function called")
        ...
        if self.current_color == "red":
            ...
            if self.last_color == "green":
                self.moving = "right"
            if self.last_color == "red":      # white to blue is moving left
                self.moving = "left"
...
class Drive:
    ...
    def turn_left(self,time_run,speed):
        #print("Turning Left")
        self.throttle(speed,-0.5*speed,"FWD")
        #time.sleep(time_run)

    def turn_right(self,time_run,speed):
        #print("Turning Right")
        self.throttle(0.25*speed,speed,"FWD")
        #time.sleep(time_run)
