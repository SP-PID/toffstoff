...
class MainMenu:
    ...
    def estop_state(self): # emergency stop function stops all processes and ends program
        ...
        self.Selected = 0
        time.sleep(1)
        disp.text_scroll(self.Current,self.States)
...
class Navigate:
    ...
    def navi(self):
        while True:
            ...
            if 115 < RGB[0] < 130 and 0 < RGB[1] < 10 and 0 < RGB[2] < 10:# determines if the color red is being seen
                self.current_color = "red" # (125, 3, 2) ## REDGREEN = (28,26,7)
            elif 0 < RGB[0] < 10 and 15 < RGB[1] < 30 and 15 < RGB[2] < 30:# determines if the color blue is being seen
                self.current_color = "blue" # (6, 27, 27) ## BLUEGREEN = (8,31,21)
            elif 0 < RGB[0] < 15 and 40 < RGB[1] < 50 and 5 < RGB[2] < 15:# determines if the color green is being seen 
                self.current_color = "green" # (8, 45, 11)
            elif 20 < RGB[0] < 35 and 15 < RGB[1] < 25 and 0 < RGB[2] < 10:# determines if the color white is being seen 
                self.current_color = "white" # (29,21,7)
            if self.direction == "C":
                self.is_moving_to_CCW() # function determines if the robot is moving to the left or right
            else:
                self.is_moving_to_CW()
    ...
    def is_moving_to_CCW(self):
        if self.current_color == "red":
            ...
            if self.last_color == "blue":       # blue to green is moving left
                self.moving = "left"
            if self.last_color == "green":      # green to green is moving straight
    ...
    def is_moving_to_CW(self):
        if self.current_color == "red":
            if self.last_color == "green":      # red to green is moving right
                self.moving = "right"
            if self.last_color == "white":      # red to white is moving left
                self.moving = "left"
        elif self.current_color == "green":
            if self.last_color == "red":        # green to red is moving left
                self.moving = "left"
            if self.last_color == "blue":       # green to blue is moving right
                self.moving = "right"
            if self.last_color == "green":      # green to green is moving straight
                self.moving = "straight"
        elif self.current_color == "blue":
            ...
            if self.last_color == "blue":       # blue to white means off the track to the left
                self.moving = "offleft"
            if self.last_color == "red":        # red to white means off the track to the right
                self.moving = "offright"

    def make_turns(self):
        ''' Function that determines what the motors should do '''
        if self.current_color == "green":   # if green is being seen, then go forward
            drive.forward(self.speed)
        if self.current_color == "red":     # if red is being seen, correct to the right
            drive.correct_right(self.speed)
        elif self.current_color == "blue":  # if blue is being seen, correct to the left
            drive.correct_left(self.speed)
        elif self.current_color == "white": # white is being seen and robot is moving straight
            if self.moving == "straight":   # spin around and find the track
                drive.spin(self.speed)
        elif self.moving == "left":         # if robot is moving to the left and white is being seen then turn hard right
            if self.current_color == "white":
                drive.turn_right(0.025,self.speed)
            else:
                drive.forward(self.speed)
        elif self.moving == "right":        # if robot is moving to the right and white is being seen turn hard left
            if self.current_color == "white":
...
class Drive:
    ...
    def forward(self,speed):
        self.throttle(speed,speed-10,"FWD")
